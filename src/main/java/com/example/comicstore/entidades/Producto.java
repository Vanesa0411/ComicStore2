...
@Entity // Se carga el paquete para crear la BD a traves de JAVA
@Table(name="producto") //se crea el nombre de la tabla

public class Producto {

    @Id //vuelve el registro Id como la clave primaria
    @GeneratedValue(strategy = GenerationType.IDENTITY) // Se crea para asignar el id automatico y autoincrementa

    @Column(name ="id") //Se crea el campo en la tabla, uno a uno
    private  Integer id;
    @Column(name="nombre")
